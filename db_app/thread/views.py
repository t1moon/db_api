...
from db_app.queries.thread import INSERT_THREAD, INSERT_SUBSCRIPTION, DELETE_SUBSCRIPTION, \
    UPDATE_THREAD_VOTES, UPDATE_THREAD, UPDATE_THREAD_SET_IS_CLOSED_FLAG, UPDATE_THREAD_DELETED_FLAG, \
    UPDATE_THREAD_POSTS_DELETED_FLAG, SELECT_THREAD_DELETED_FLAG_BY_ID, UPDATE_THREAD_POSTS, \
